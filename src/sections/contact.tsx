...
export default function Contact() {
    ...
    return(
        <motion.div
            className="h-dvh py-10 px-6 md:px-80 grid grid-rows-[auto_1fr_auto] gap-10 md:gap-18 relative"
            initial={{ opacity: 0 }}
        ...
        >
            ...
            <motion.div
                className="absolute md:relative bottom-10 md:bottom-none left-1/2 md:left-none -translate-x-1/2 w-[90%] md:w-full flex items-center justify-between font-yekan-bakh text-base md:text-xl border border-white/30 bg-[#002FFF05] backdrop-blur-[30px] px-4 md:px-18 py-7 mb-4 md:mb-0 rounded-full"
