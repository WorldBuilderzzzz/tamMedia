...
export default function Contact() {
    ...
    return(
        ...
        >
            ...
            <motion.div
                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[90%] flex items-center justify-between font-yekan-bakh text-base md:text-xl border border-white/30 bg-[#002FFF05] backdrop-blur-[30px] px-4 md:px-18 py-7 mb-4 md:mb-0 rounded-full"
