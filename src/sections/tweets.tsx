...
export default function Tweets () {
    ...
    const tweets: {id: string, title: string, badges?: {title: string, link: string}[], instagram_id: string, image: string, description: string,}[] = [
        ...
        },
        {
            ...
            image: "mehravid", 
            description: "به نام خدا؛ اینجا کلینیک دندانپزشکی مهرآویده. نزدیک به دو ساله با بچه‌های گروه تام مدیا همکاری می‌کنیم؛ بچه‌های بسیار منظم، مرتب و مؤدبی هستن و بارز‌ترین شاخصه‌شون خلاقیت و ایده‌های نو هستش؛ موفق باشید."
        },
        {
            id: "3",
            title: "سوگند نتاج",
